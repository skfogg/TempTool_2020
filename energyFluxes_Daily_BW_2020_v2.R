...
load("longwaveHighHypo.RData")
load("longwaveLittleHypo.RData")
load("longwaveMedHypo.RData")
...
load("shortwaveHighHypo.RData")
load("shortwaveLittleHypo.RData")
load("shortwaveMedHypo.RData")
