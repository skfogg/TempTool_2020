...
png("C:/Users/t24x137/Desktop/TempTool_2020/plots/AnnualTemperature.png",
    width = 2000*3,
    height = 1900*3,
    res = 72*3)
...
axis(side = 1,
     labels = c("", "", "", "", "", "", "", "", "", ""),
     at = ymd("2016-01-01", "2016-03-01", "2016-05-01", "2016-07-01", "2016-09-01", "2016-11-01", "2017-01-01", "2017-03-01", "2017-05-01", "2017-07-01"))
